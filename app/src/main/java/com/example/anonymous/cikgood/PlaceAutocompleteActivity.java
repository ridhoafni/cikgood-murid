...
//                            .setGeodesic(true);
                    ...
                    // Tambah Marker
//                    mMap.addMarker(new MarkerOptions().position(pickUpLatLng).title("PengalamanKerja Awal"));
//                    mMap.addMarker(new MarkerOptions().position(locationLatLng).title("PengalamanKerja Akhir"));
                    // Dapatkan jarak dan waktu
