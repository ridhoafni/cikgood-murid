...
public class MapsMurid extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_murid);
    ...
    private void putExtraDataToPemesananLokasi() {
        ...
        btnPosisi.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Log.d("maps jadwal2", ""+alamat);

                Intent intent;
                intent = new Intent(MapsMurid.this, RegisterAccountActivity.class);
...
//                intent.putExtra(PemesananJadwalActivity.KEY_HARGA, tarif);
                intent.putExtra(RegisterAccountActivity.KEY_LATITUDE, lat);
                intent.putExtra(RegisterAccountActivity.KEY_LONGITUDE, lng);
                intent.putExtra(RegisterAccountActivity.KEY_ADDRESS, alamat);
