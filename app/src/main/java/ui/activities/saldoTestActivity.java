...
public class saldoTestActivity extends AppCompatActivity implements TransactionFinishedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saldo_test);
        bindViews();
    ...
    private void initActionButtons() {
        buttonUiKit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this);
            }
        });
        ...
        buttonDirectCreditCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().UiCardRegistration(saldoTestActivity.this, new CardRegistrationCallback() {
                    @Override
                    public void onSuccess(CardRegistrationResponse cardRegistrationResponse) {
                        Toast.makeText(saldoTestActivity.this, "register card token success", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(CardRegistrationResponse cardRegistrationResponse, String s) {
                        Toast.makeText(saldoTestActivity.this, "register card token Failed", Toast.LENGTH_SHORT).show();
        ...
        buttonDirectBcaVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this, PaymentMethod.BANK_TRANSFER_BCA);
            }
        });
        ...
        buttonDirectBniVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this, PaymentMethod.BANK_TRANSFER_BNI);
            }
        });
        ...
        buttonDirectMandiriVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this, PaymentMethod.BANK_TRANSFER_MANDIRI);
            }
        });
        ...
        buttonDirectPermataVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this, PaymentMethod.BANK_TRANSFER_PERMATA);
            }
        });
        ...
        buttonDirectAtmBersamaVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(saldoTestActivity.this, PaymentMethod.BCA_KLIKPAY);
            }
        });
