...
public class LoginAnimationsActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_animations);
        ...
        sBtnLoading.setOnResultEndListener(new SubmitButton.OnResultEndListener() {
            ...
            public void onResultEnd() {
                Toast.makeText(LoginAnimationsActivity.this, "ResultEnd", Toast.LENGTH_SHORT).show();
            }
        });
